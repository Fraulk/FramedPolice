...
def compareNames(member, msgContent):
    ...
    return member.name.lower() == msgContent.lower() or member.display_name.lower() == msgContent.lower() or member.global_name.lower() == msgContent.lower() or member.nick.lower() == msgContent.lower()